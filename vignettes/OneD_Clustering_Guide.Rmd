...
## Automated Reporting with generateReport()

The `generateReport()` function creates a comprehensive analysis summary that can be exported as an HTML report, including all plots, tables, and analysis choices.
