...
saveRDS(TimeSeries, file = 'inst/Data/Synthetic/TimeSeries.RDs')
saveRDS(Annotations, file = 'inst/Data/Synthetic/Annotations.RDs')
...
saveRDS(TimeSeries, file = 'inst/Data/Synthetic/TimeSeries_Classification.RDs')
saveRDS(Annotations, file = 'inst/Data/Synthetic/Annotations_Classification.RDs')
